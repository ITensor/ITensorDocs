---
name: ITensorDocs.jl bug report
about: Create a bug report to help us improve ITensorDocs.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("ITensorDocs")`:
```julia
julia> using Pkg; Pkg.status("ITensorDocs")
[YOUR OUTPUT HERE]
```
